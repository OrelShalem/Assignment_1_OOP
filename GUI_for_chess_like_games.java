...
public class GUI_for_chess_like_games extends JFrame {
    ...
    private final JLabel playerTowWinsLabel = new JLabel("\\U+265F Player 2 Wins: 0");//
    private final JLabel playerOneWinsLabel = new JLabel("\\U+2659 Player 1 Wins: 0");//
    ...
    private void updateWinsLabels(int attackerWins, int defenderWins) {
        playerTowWinsLabel.setText("\\U+265F Player 2 Wins: " + attackerWins);
        playerOneWinsLabel.setText("\\U+2659 Player 1 Wins: " + defenderWins);
    }
